...
bias1 = tf.Variable(tf.constants(0.0, shape=[64]))
kernel1 = tf.conv2d(image_holder, weight1, [1,1,1,1], padding='SAME')
...
norm2 = tf.nn.lrn(conv2, 4, bias=1.0, aplha=0.001/9.0, beta=0.75)
...
bias4 = tf.Variable(tf.constants(0.1, shape=[192]))
